...
public class ConfigReloadListener extends AbstractMythicIntegration implements Listener {
    ...
    protected void shutdownIntegration() {
        try {
            ...
            if (listenerRegistered) {
                ...
                debug("MythicMobs重载监听器已注销");
            }
        } catch (Exception e) {
            debug("注销MythicMobs重载监听器时发生错误: " + e.getMessage());
        }
    }
    ...
    public void onMythicReload(MythicReloadedEvent event) {
        try {
            ...
            debug("MythicMobs重载事件已处理，立即开始更新物品");
    ...
    public String getMythicVersion() {
        ...
        try {
            ...
            debug("获取MythicMobs版本时发生错误: " + e.getMessage());
            return "获取失败";
        }
    }
    ...
    public String getMythicStatus() {
        ...
        try {
            ...
            debug("获取MythicMobs状态时发生错误: " + e.getMessage());
            return "状态获取失败";
        }
    }
    ...
    public boolean testMythicConnection() {
        try {
            ...
            debug("测试MythicMobs连接时发生错误: " + e.getMessage());
            return false;
        }
    }
}
